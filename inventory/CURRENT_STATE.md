...
system qualification, historical Executor-v10 NCU attribution validation, Executor v22 release and Compiler v10
release. The final
...
- Compiler Revision `open-cake-ir-sm100a-v10` binds the exact Target, public Schedule authoring contract, 33-source
  ...
  candidate is its Corpus regression. Its 34-object source archive passes immediate external audit.
...
- Current Executor Revision `open-cake-ir-b200-v22` binds 34 runtime sources, including deterministic external
  ...
  retain v2–v5, and v6–v21 are superseded; `inventory/EXECUTOR_REVISIONS.json` resolves all twenty-two revisions. v19
  ...
  all-Runs-qualified rule and reports unchanged. The Lab makes Claim Scope the single authority for choosing the
...
- The current local contract suite passes 334 tests plus 223 subtests; the earlier remote qualification passed its
