# Python artifact optimization — Metal scaffold v3

Use the supplied Workload Contract and Python starter to propose structurally distinct
Schedules for the declared exact Apple target and shape. Preserve Workload metadata,
...
This Metal v3 scaffold is a separate authoring treatment from v2. Keep its Runs separate;
