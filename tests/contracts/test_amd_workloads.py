...
class AmdWorkloadTests(unittest.TestCase):
    ...
    def test_llama_v1_bytes_remain_the_historical_authority(self) -> None:
        workload = WorkloadContract.load(RMSNORM_V1)

        self.assertEqual(
            workload.canonical_sha256,
            "5adff7b771267e233e9ebe2f9cd900170c4ea14010f8c8749cf3eef2165342d8",
        )
