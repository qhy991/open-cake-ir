...
| 在 Apple M1 Pro 或 M2 上通过 TaskLab 优化归一化任务 | [Metal 入门](../metal.zh-CN.md) |
...
| 让下一轮使用每个任务已验证的最佳实现 | [Task incumbent](TASK_INCUMBENTS.md) |
| Agent 怎样逐项读已有反馈，以及怎样验证反馈是否有用 | [Rubric 反馈](RUBRIC_FEEDBACK.md) |
