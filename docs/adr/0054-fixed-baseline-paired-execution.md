# ADR 0054 — One fixed-baseline paired assay per candidate
...
Historical single receipts and old locks retain read-only replay. New live native
Campaigns require the explicit paired policy and current closed provider surface;
