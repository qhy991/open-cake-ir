# ADR 0069: a single-writer state update is a proven store effect

Status: proposed successor Compiler change, 2026-09-01. Renumbered from 0039 on
2026-09-18; that number was already held by
[0039-logical-register-pressure-is-not-a-physical-bound.md](0039-logical-register-pressure-is-not-a-physical-bound.md).
