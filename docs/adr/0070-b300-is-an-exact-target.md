# ADR 0070: B300 is an exact target on the existing Triton path

Status: proposed, 2026-09-07; independent design review completed. Renumbered from 0053
on 2026-09-18; that number was already held by
[0053-study-bound-advisory-cost-selection.md](0053-study-bound-advisory-cost-selection.md).
The release review this awaited was replaced by
[ADR 0065](0065-source-identity-is-the-commit.md); `sm_103a` is a declared Target with a
committed host capture under `runtime/hosts/`.
