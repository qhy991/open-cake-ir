...
```bash
open-cake-ir lab preflight contracts/studies/matched-search-infrastructure-v26.json \
...
The current checked-in scientific matched contract, `matched-search-infrastructure-v26.json`, uses a zero-GPU fixture
...
non-scientific G8 template is `matched-search-system-qualification-v26.json`; earlier versions remain frozen
...
`artifact-optimization-v26.json` is the current zero-GPU contract fixture. The frozen
...
`matched-search-clean-start-reference-v26.json` is the reference-access fixture. It inherits the scientific
...
python tools/create_study_successor.py \
  --source contracts/studies/matched-search-infrastructure-v26.json \
...
python tools/freeze_live_matched_study.py \
  --project-root . \
  --template contracts/studies/matched-search-system-qualification-v26.json \
  --qualification contracts/providers/<new-live-receipt>.json \
  --qualification-anchor evidence/qualifications/<new-live-anchor>.json \
  --executor runtime/executors/open-cake-ir-b200-v25.json \
