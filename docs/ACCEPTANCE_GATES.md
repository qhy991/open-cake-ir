...
| G6 | passed | 326 tests + 223 subtests cover candidate-set transport/selection/replay, all-or-nothing calibrated ordering, tool-rich scratch lifecycles, artifact-only feedback-budget freezing, immutable CLI reports, Claim-Scope provider routing, external Campaign custody, Lab authority, GPU tutorial custody, attribution replay, preregistered ranking-calibration replay and all three matched Claim Scopes |
