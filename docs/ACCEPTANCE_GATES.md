...
| G6 | passed | 325 tests + 223 subtests cover candidate-set transport/selection/replay, tool-rich scratch lifecycles, artifact-only feedback-budget freezing, immutable CLI reports, Claim-Scope provider routing, external Campaign custody, Lab authority, GPU tutorial custody, attribution replay and all three matched Claim Scopes |
