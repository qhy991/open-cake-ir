...
| G3 | passed | v14 21-case Corpus Gate, released content-bound Revision lock, reviewed approval and 37-source closure; authoring-schema parity plus SwiGLU and Top-K shape drifts are failure-capable regression gates, while the scientific-v3 Triton warp-specialized argmin failure remains lowering-ineligible |
