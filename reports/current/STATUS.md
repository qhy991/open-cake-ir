...
- 版本： `open-cake-ir-sm100a-v57`
- 状态： `released`
- 目标： `apple_gpu_family8, gfx1151, sm_100a`
- 语料检查： `96/96` 项符合预期
- 绑定源码： `135` 个文件
- 已发布校准： `无`
...
- 版本： `open-cake-ir-b200-v53`
- 状态： `released`
- 绑定源码： `64` 个文件
- 负责记录： [`inventory/EXECUTOR_REVISIONS.json`](../../inventory/EXECUTOR_REVISIONS.json)
- 描述文件： [`runtime/executors/open-cake-ir-b200-v53.json`](../../runtime/executors/open-cake-ir-b200-v53.json)
