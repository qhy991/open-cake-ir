...
@cake.schedule(name="xcore1002-dot-fp16-64", target="xcore1002", backend="triton",
               entry_point="xcore1002_dot_fp16_64")
def matrix(lm, a: cake.Tensor((64, 64), "fp16"),
    ...
    with compute:
        ...
        result = lm.mma(left, right, instruction={"contract": "triton.dot.fp16_fp32"},
