...
@cake.schedule(name="xcore1002-dot-tf32-unqualified-64", target="xcore1002", backend="triton",
               entry_point="xcore1002_dot_tf32_unqualified_64")
def matrix(lm, a: cake.Tensor((64, 64), "fp32"),
    ...
    with compute:
        ...
        result = lm.mma(left, right, instruction={"contract": "triton.dot.fp32_tf32"},
