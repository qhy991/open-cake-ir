...
@cake.schedule(name="xcore1002-dot-bf16-64", target="xcore1002", backend="triton",
               entry_point="xcore1002_dot_bf16_64")
def matrix(lm, a: cake.Tensor((64, 64), "bf16"),
           b: cake.Tensor((64, 64), "bf16"),
