...
@cake.schedule(name="xcore1002-dot-operand-dtype-drift-64", target="xcore1002", backend="triton",
               entry_point="xcore1002_dot_operand_dtype_drift_64")
def matrix(lm, a: cake.Tensor((64, 64), "fp16"),
           b: cake.Tensor((64, 64), "fp16"),
    ...
    with compute:
        ...
        result = lm.mma(left, right, instruction={"contract": "triton.dot.bf16_fp32"},
