...
def execute_matched_from_config(
    ...
    config = load_runtime_config(runtime_config_path, toolchain_kind=policy.backend if policy is not None else "nvcc")
    ...
    if policy is not None and paired_protocol(protocol) is None:
