...
- F-2026-09-10-012 — native/CuTe admission omitted explicit ownership, cache, scalar, state and target contracts (bug, local public-boundary probes; successor approval and replay pending)
