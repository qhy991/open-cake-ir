...
- F-2026-09-17-011 — a qualified gemm on gfx938 lowered a contraction with no matrix instruction, and the cause is dtype, not choice: the task is fp32 and the Target declares dot contracts only for fp16 and fp8e4m3, so the same case moved to fp32 assesses accepted=False. sm_103a declares fp32 forms; gfx938 declares none because none has been measured (capacity, proposed)
