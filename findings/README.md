...
- F-2026-09-17-011 — gfx938 declares `mma`, the Gate covers it and the ISA answers it, and a qualified gemm campaign still lowered a contraction with no matrix instruction anywhere in its AMDGCN; the author was given the contracts and did not reach for them, and nothing in the loop measures that gap (capacity, proposed)
