...
- F-2026-09-15-005 — explicit caller-selected Triton CTA width from RMSNorm-gradient and SwiGLU evidence (capacity; bounded pass and paired successor validation)
