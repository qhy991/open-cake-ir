...
- F-2026-09-15-001 — provider faults killed by the subscription quota wall recorded only a generic exit-code failure while the explaining rate-limit notice stayed in the retained stdout (protocol, 19 overnight instances; observed_quota attribution at the fault seam)
