...
- F-2026-09-17-010 — kimi-k3 and deepseek-v4-flash both reach for Bash, which the authoring environment does not offer, and the run is refused; 2 of 13 DCU attempts and 1 of 13 on B300. The refusal is the reference-access contract working and widening the tool set would trade the comparison for throughput (behavior, proposed)
