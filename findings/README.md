...
- F-2026-09-14-005 — subscription-authenticated Claude sessions report a surpassedThreshold fraction on the quota warning event, stranding provider qualification (protocol, admitted in Executor v116 with utilization's type and range validation; replay qualification on the successor owed)
