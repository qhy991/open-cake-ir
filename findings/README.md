...
- F-2026-09-16-001 — a kimi-k3 experiment service runs seven B300 tasks end to end, every campaign protocol-adherent, custody-verified and semantically replayed (behavior, artifact_optimization_only; the launcher's default gpu-run socket is not this host's, and it costs a full authoring turn to find out)
