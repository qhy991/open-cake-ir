...
def main() -> int:
    ...
    if arms not in (["open_cake", "direct_cuda"], ["open_cake", "native_triton"], ["open_cake"]):
        raise ValueError("qualification output schema must declare a supported arm pair or single Open Cake arm")
